...
class ShipmentTab(QWidget):
    ...
    def __init__(self, data_manager: DataManager):
        ...
        self.client_input.addItems(list(self.data_manager.clients.keys()))
        ...
        self.product_input.addItems([p["product_name"] for p in self.data_manager.products_list])
        ...
        self.warehouse_input.addItems([w["warehouse_number"] for w in self.data_manager.warehouses])
    ...
    def update_warehouses(self):
        """Обновляет список складов в комбобоксе."""
    ...
    def update_products(self):
        """Обновляет список продуктов в комбобоксе."""
    ...
    def update_delivery_address(self, client_name):
        ...
        city = self.data_manager.clients.get(client_name, "")
        self.delivery_address_input.setText(city)
        self.calculate_delivery_time()
    ...
    def calculate_delivery_time(self):
        ...
        # Предположим, что в поле 'address' хранится полный адрес, извлекаем город
    ...
    def get_warehouse_info(self, warehouse_number):
        ...
        for wh in self.data_manager.warehouses:
            if wh["warehouse_number"] == warehouse_number:
                return wh
        return None
    ...
    def update_total_amount(self):
        ...
        # Предположим, что цена товара хранится в DataManager's products_list
        price = 0
        for p in self.data_manager.products_list:
    ...
    def load_data(self):
        """Загружает существующие заказы из DataManager и отображает их в таблице."""
        self.shipment_table.setRowCount(0)
        for shipment in self.data_manager.shipments:
