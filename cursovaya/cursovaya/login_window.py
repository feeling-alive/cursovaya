...
from data_manager import Administrator  # Модель для таблицы administrators
...
class LoginDialog(QDialog):
    ...
    def handle_login(self):
        ...
        try:
            ...
            query = select(Administrator).where(Administrator.username == username)
            admin = session.execute(query).scalar_one()
